...
import com.portfolio.fjc.Seguridad.Servicio.RolServicio;
import com.portfolio.fjc.Seguridad.Servicio.UsuarioServicio;
import com.portfolio.fjc.Seguridad.jwt.JwtProvider;
...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = {"https://fjc-p-frontend.web.app","http://localhost:4200"})
